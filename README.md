...
1. Найдите фото автомобиля по номеру B408MX77 в интернете
2. Определите цвет автомобиля на фото
...
def solve_problem(target1, target2):
    ...
    if found:
        ...
        print("🔍 Для определения цвета:")
        print(f"1. Найдите фото автомобиля по номеру {found} в интернете")
        print(f"2. Определите цвет автомобиля на фото")
    else:
